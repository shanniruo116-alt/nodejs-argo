...
const PROJECT_URL = process.env.PROJECT_URL || 'https://beyoundtime-production-8b80.up.railway.app';    // 需要上传订阅或保活时需填写项目分配的url,例如：https://google.com
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'bb.beyoundtime.dpdns.org';          // 固定隧道域名,留空即启用临时隧道
...
const CFIP = process.env.CFIP || 'bb.beyoundtime.dpdns.org';        // 节点优选域名或优选ip  
